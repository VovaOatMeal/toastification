...
void main() {
  group('ToastificationType', () {
    test('Default types', () {
      ...
      expect(
          ToastificationType.success.icon, Icons.check_circle_outline_outlined);

      expect(ToastificationType.warning.name, 'warning');
      expect(ToastificationType.warning.color, warningColor);
      expect(ToastificationType.warning.icon, Icons.warning_amber);
    ...
    test('toString returns correct string representation', () {
      ...
      const customType =
          ToastificationType.custom('custom', Colors.purple, Icons.favorite);
